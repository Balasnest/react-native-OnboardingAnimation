...
inboxData = [{
  ...
  "message": "In hac habitasse platea dictumst. In hac habitasse platea dictumst. In hac habitasse platea dictumst. In hac habitasse platea dictumst. In hac habitasse platea dictumst."
}, {
  "id": 2,
  "first_name": "Dennis",
...
export default class Inbox extends React.Component {
	...
	renderItem = ({item}) => {
		return (<EachMessage rowData = {item} />)
	}
		...
		return(
			<ScrollView style={styles.container}>
				<View style={{marginLeft: 5}}>
					...
					<View style={{borderBottomWidth: 1, margin: 20, borderColor: '#e1e1e1'}} />
					<View>
